...
%
%    The Daubechies filters are minimal phase filters that generate wavelets which
%    have a minimal support for a given number of vanishing moments.  They are
%    indexed by their length, Par, which may be one of 2..10. The number of vanishing
%    moments is par.
%
