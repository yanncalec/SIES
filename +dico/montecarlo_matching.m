...
% Monte-carlo test for dictionary matching algorithm. This function provides a general framework for 
% the test of a dictionary matching algorithm on some data set. For a range of noise level, it 
% reconstructs features from the noisy data and compute shape descriptors, then matches in the 
% precomputed dictionary. By providing function handles of the physic-specified reconstruction and 
% of the dictionary matching, this function can work for different types of problems.
%
% Inputs:
