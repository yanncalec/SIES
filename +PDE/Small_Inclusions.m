...
% Abstract class for several PDEs involving small inclusions in a homogeneous medium (e.g., Electric
% Impedance Tomography, Helmholtz equation). These PDEs have some common characteristics:    
% 1. The domain is illuminated by a (point) source
% 2. The solution can be represented using layer potentials
% 3. Decomposition formula exists for the solution which allows to reconstruct the asymptotics like GPT.
